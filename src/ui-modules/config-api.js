...
const CONFIG_RESPONSE_KEYS = [
    ...
    'RUNTIME_STORAGE_ENABLE_LEGACY_FILE_BRIDGE',
...
export async function handleUpdateConfig(req, res, currentConfig) {
    try {
        ...
        if (newConfig.RUNTIME_STORAGE_ENABLE_LEGACY_FILE_BRIDGE !== undefined) currentConfig.RUNTIME_STORAGE_ENABLE_LEGACY_FILE_BRIDGE = newConfig.RUNTIME_STORAGE_ENABLE_LEGACY_FILE_BRIDGE;
